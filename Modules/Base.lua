...
function mog.base.AddSlot(slot,addon)
	...
	return function(id,display,itemname,itemLevel,quality,lvl,faction,class,bind,slot,sheath,source,sourceid,zone,sourceinfo, storeID)
		tinsert(list,id);
		...
		mog:AddData("item", id, "storeID", storeID);
